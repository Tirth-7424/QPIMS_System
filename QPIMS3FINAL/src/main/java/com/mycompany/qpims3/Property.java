...
/*
Property class contains all the attributes related to a property. 
Property class also has nessaccary methods like constructor, setter, getter and toString.
*/
