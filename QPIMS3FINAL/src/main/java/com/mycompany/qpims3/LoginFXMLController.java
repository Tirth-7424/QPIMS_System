...
/*
LoginFXMLController is associated with LoginFXML, this page provides asseccibilty to login and verify the ceredentials
from databse. This Controller also has got methods to exit the system and switch to register page.
*/
