...
/*
MainMenuController is associated with MainMenu FXML and can be called as the gateway to different sections of application.
MainMenu is navigation pathway to functions related to customer, property, repairjobs and report.
*/
...
// Below are the elements used in developing the FXML page. 
    ...
    private void switchToAbout() throws IOException {
        // Function to switch the scene to About.
        App.setRoot("About");
